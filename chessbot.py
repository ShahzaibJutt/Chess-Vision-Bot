...
BOARD_LEFT_COORD = 2
CONFIDENCE = 0.8
DETECTION_NOICE_THRESHOLD = 15
PIECES_PATH = './src/piece_recognition/pieces/'
...
def search(fen):
    ...
    engine = chess.engine.SimpleEngine.popen_uci(
        r"C:\Users\Shahzaib\Downloads\opencv-chess-bot\src\Stockfish\stockfish_20011801_x64_modern.exe")
